            ...
            <table className="min-w-full divide-y-2 divide-gray-200 bg-dark rounded-md text-sm">
                <thead className="ltr:text-left rtl:text-right">
                    ...
                    <th className="px-4 py-6">
                        ...
                        <th className="whitespace-nowrap px-4 py-2 font-bold text-center text-white">Username</th>
                ...
                <tbody className="divide-y divide-gray-200">
                    {users.map((user, index) => (
                        <tr key={user._id}>
                            ...
                            <td className="whitespace-nowrap px-4 py-2 text-white text-center">{user.username}</td>
