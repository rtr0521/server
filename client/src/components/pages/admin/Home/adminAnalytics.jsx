...
const adminAnalytics = () => {
  ...
  return (
    <div className="flex h-full  ">
      <Sidebar/>
      <div className="w-96 h-full flex items-center justify-center p-7 lg:w-full ">
        <section className="w-96 lg:w-full">
          <div className="flex items-center jsutify-center flex-col lg:grid lg:grid-col-4 lg:gap-4 lg:place-content-center lg:w-full lg:h-full">
            <div className="w-96 lg:w-full flex-col mb-4 flex lg:flex-row items-center justify-between gap-4">
            ...
            <div className="w-full mb-4 row-span-2 shadow-md rounded-md lg:w-full h-96 p-10 flex flex-col items-center bg-dark">
            <h1 className="text-white text-lg font-bold">Progress Task Progress Activities</h1>
              <PieGraph />
            </div>
            <div className=" mb-4 shadow-md rounded-md w-full h-auto p-3 bg-dark">
              <h1 className="text-white text-xl font-bold mb-10">Top 10 Progress Activities Progress Activities</h1>
              <BarGraph />
            </div>
          </div>
        </section>
