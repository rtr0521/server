    ...
    return (
      <div>
        ...
        <div className="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 h-screen flex overflow-hidden text-sm">
          <div className="bg-black dark:bg-gray-900 dark:border-gray-800 w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
            ...
            <div className="h-16 lg:flex w-full border-b border-gray-200 dark:border-gray-800 hidden px-10">
              ...
              <div className="ml-auto flex items-center space-x-7">
                ...
                <button className="flex items-center">
                  ...
                  <span className="ml-2">Daniel De Torres</span>
                  <svg
                    viewBox="0 0 24 24"
            ...
            <div className="flex-grow flex overflow-x-hidden">
              <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto lg:block hidden p-5">
                ...
                <div className="space-y-4 mt-3">
                  <button className=" p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                  ...
                  <button className=" p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow-lg relative ring-2 ring-blue-500 focus:outline-none">
                    <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 dark:text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 dark:border-gray-700 w-full">
                      <img
              ...
              <div className="flex-grow bg-dark dark:bg-gray-900 overflow-y-auto">
                <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-dark dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
