        ...
        <header className="flex items-center justify-between w-full h-20 lg:h-32 p-7">
          <div className="">
            <div className="flex items-center justify-center">
              <h1 className="text-2xl mr-2 font-bold text-white">Military Performance Monitoring</h1>
              <span className="hidden lg:flex bg-transparent border-1 border-white rounded-2xl p-2 text-white">
                70 Platoon
              </span>
            </div>
            <div className="header-sub">
              <p className=" text-md text-gray-300">Keep track of vendor and their security ratings.</p>
            </div>
          </div>
          <div className="button">
            <dialog id="my_modal_5" className="modal sm:modal-middle">
              <div className="modal-box  border-white text-white border">
                <h3 className="font-bold text-lg bg-transparent border-b border-">Add a To Do! ✏️</h3>
